    ...
    <div className="flex flex-col h-full min-h-0">
      <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold">Your First Quest</h2>
        ...
        {loading ? (
          ...
          <Card className="p-4 sm:p-6 max-w-lg mx-auto bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
      ...
      <div className="sticky bottom-0 flex-shrink-0 p-4 border-t bg-background/95 backdrop-blur z-10 pb-[calc(1rem_+_env(safe-area-inset-bottom,0px))] sm:pb-6">
        <div className="flex justify-center">
          <Button onClick={onNext} size="lg" className="px-8 w-full sm:w-auto gap-2">
            Got It, Let's Go!
